...
def second_form_view(request):
    ...
    if 'sugerencia' in request.POST:
        ...
        if formdos.is_valid():
            ...
            return render(request, 'home.html', {'time_to_wedding': time_to_wedding, 'postdos': postdos, 'form': form, 'formdos':formdos, 'formtres': formtres, 'ancla':ancla,'fotoprincipal':Imagenes.objects.get(name='fotoprincipal'),
                                              'finca': Imagenes.objects.get(name='finca'),
                                              'church': Imagenes.objects.get(name='church'),
                                              'bus': Imagenes.objects.get(name='bus'),
                                              'party': Imagenes.objects.get(name='party'),
